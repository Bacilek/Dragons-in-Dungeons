...
const ITEM_POOL: Array = [
	...
	{"name": "Short Bow",      "type": 0, "icon": "Weapons/BowArrow.png",                 "src": "items",   "bonus_dmg": 1, "heal": 0, "str_bonus": 0, "fmin": 2, "fmax": 6,  "desc": "Ranged, DEX-based. Normal range 4, long range = FOV (DISADV). Requires Arrows.", "is_ranged": true, "range": 4, "dmg_type": "Piercing", "category": "Simple", "die_min": 1, "die_max": 6, "mastery": "Vex", "ammo": "Arrow"},
	{"name": "Heavy Crossbow", "type": 0, "icon": "Weapons/BowArrowGold.png",             "src": "items",   "bonus_dmg": 3, "heal": 0, "str_bonus": 0, "fmin": 5, "fmax": 10, "desc": "Ranged, DEX-based. Normal range 4, long range = FOV (DISADV).", "is_ranged": true, "range": 4, "dmg_type": "Piercing", "category": "Martial", "heavy": true},

...
const ITEM_POOL: Array = [
	...
	{"name": "Heavy Crossbow", "type": 0, "icon": "weapons/bow_arrow_gold.png",             "src": "items",   "bonus_dmg": 0, "heal": 0, "str_bonus": 0, "fmin": 6, "fmax": 10, "desc": "Ranged, DEX-based. Normal range 4, long range 16 (DISADV). Heavy (DEX 13+), two-handed. Requires Bolts.", "is_ranged": true, "range": 4, "long_range": 16, "dmg_type": "Piercing", "category": "Martial", "die_min": 1, "die_max": 10, "mastery": "Push", "ammo": "Bolt", "heavy": true, "two_handed": true, "gold": 120},

...
const ITEM_POOL: Array = [
	...
	{"name": "Scroll of Cure Wounds", "type": 3, "icon": "cure_wounds.png", "src": "spells", "bonus_dmg": 0, "heal": 0, "str_bonus": 0, "fmin": 1, "fmax": 10, "desc": "Reading this casts Cure Wounds once, then it crumbles to dust.", "scroll_spell": "cure_wounds", "gold": 50},
	{"name": "Scroll of Aid", "type": 3, "icon": "aid.png", "src": "spells", "bonus_dmg": 0, "heal": 0, "str_bonus": 0, "fmin": 3, "fmax": 10, "desc": "Reading this casts Aid once, then it crumbles to dust.", "scroll_spell": "aid", "gold": 70},
	{"name": "Scroll of Barkskin", "type": 3, "icon": "barkskin.png", "src": "spells", "bonus_dmg": 0, "heal": 0, "str_bonus": 0, "fmin": 3, "fmax": 10, "desc": "Reading this casts Barkskin once, then it crumbles to dust.", "scroll_spell": "barkskin", "gold": 70},

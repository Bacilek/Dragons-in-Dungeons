...
const ITEM_POOL: Array = [
	...
	{"name": "Torch",          "type": 0, "icon": "weapon_torch.png",             "src": "weapons", "bonus_dmg": 0, "heal": 0, "str_bonus": 0, "fmin": 1, "fmax": 10, "desc": "Melee. Simple, Light. Click while equipped (Main Hand or Off-hand) to light it: burns for 100 turns, granting +1 FOV. While lit and wielded in Main Hand, attacks also deal +1d4 Fire damage. Burns out permanently into a Burnt Torch.", "dmg_type": "Bludgeoning", "category": "Simple", "die_min": 1, "die_max": 4, "light": true, "torch": true},

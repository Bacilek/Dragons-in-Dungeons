...
const ITEM_POOL: Array = [
	...
	{"name": "Ration",         "type": 4, "icon": "Food/MeatCooked.png",                  "src": "items", "bonus_dmg": 0, "heal": 0, "food_value": 50, "str_bonus": 0, "fmin": 1, "fmax": 10, "desc": "Required for a long rest."},
	{"name": "Mystery Meat",   "type": 4, "icon": "Food/Meat.png",                        "src": "items", "bonus_dmg": 0, "heal": 0, "food_value": 25, "str_bonus": 0, "fmin": 1, "fmax": 10, "desc": "Required for a long rest."},
	...
	{"name": "Arrow",          "type": 7, "icon": "Weapons/weapon_arrow.png",             "src": "weapons", "bonus_dmg": 0, "heal": 0, "str_bonus": 0, "fmin": 1, "fmax": 10, "desc": "Ammunition for the Short Bow and Longbow.", "qty": 6},

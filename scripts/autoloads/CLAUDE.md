...
| `subclass_choice_required` | — | level 7 reached with an unchosen subclass — hud.gd spawns `subclass_select.gd` |
...
tier2_unlocked: bool         # set at level 7 — via choose_subclass() (Barbarian) or unlock_tier2() directly (other classes)

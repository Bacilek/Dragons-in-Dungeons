...
const ALL_ITEMS: Array = [
	...
	{"name": "Healing Herb",    "type": 4, "src": "items",   "icon": "Food/SaladFlowerPurple.png",            "bonus_dmg": 0, "heal": 4, "food_value": 25, "str_bonus": 0, "desc": "Eating it heals 4 HP and also counts as long-rest fuel.", "gold": 10},
	...
	{"name": "Padded Armor",           "type": 1, "src": "items", "icon": "Materials/PlateIron.png", "bonus_dmg": 0, "heal": 0, "str_bonus": 0, "desc": "Light armor. AC = 11 + DEX. Disadvantage on Stealth. Equip/unequip/swap takes 5 turns.", "armor_cat": 1, "base_ac": 11, "dex_cap": -1, "stealth_disadv": true, "gold": 5},
	{"name": "Leather Armor",          "type": 1, "src": "items", "icon": "Materials/PlateIron.png", "bonus_dmg": 0, "heal": 0, "str_bonus": 0, "desc": "Light armor. AC = 11 + DEX. Equip/unequip/swap takes 5 turns.", "armor_cat": 1, "base_ac": 11, "dex_cap": -1, "gold": 10},
	{"name": "Studded Leather Armor",  "type": 1, "src": "items", "icon": "Materials/PlateIron.png", "bonus_dmg": 0, "heal": 0, "str_bonus": 0, "desc": "Light armor. AC = 12 + DEX. Equip/unequip/swap takes 5 turns.", "armor_cat": 1, "base_ac": 12, "dex_cap": -1, "gold": 45},
	{"name": "Hide Armor",             "type": 1, "src": "items", "icon": "Materials/PlateIron.png", "bonus_dmg": 0, "heal": 0, "str_bonus": 0, "desc": "Medium armor. AC = 12 + DEX (max +2). Equip/unequip/swap takes 10 turns.", "armor_cat": 2, "base_ac": 12, "dex_cap": 2, "gold": 10},
	{"name": "Chain Shirt",            "type": 1, "src": "items", "icon": "Materials/PlateIron.png", "bonus_dmg": 0, "heal": 0, "str_bonus": 0, "desc": "Medium armor. AC = 13 + DEX (max +2). Equip/unequip/swap takes 10 turns.", "armor_cat": 2, "base_ac": 13, "dex_cap": 2, "gold": 50},
	{"name": "Scale Mail",             "type": 1, "src": "items", "icon": "Materials/PlateIron.png", "bonus_dmg": 0, "heal": 0, "str_bonus": 0, "desc": "Medium armor. AC = 14 + DEX (max +2). Disadvantage on Stealth. Equip/unequip/swap takes 10 turns.", "armor_cat": 2, "base_ac": 14, "dex_cap": 2, "stealth_disadv": true, "gold": 50},
	{"name": "Breastplate",            "type": 1, "src": "items", "icon": "Materials/PlateIron.png", "bonus_dmg": 0, "heal": 0, "str_bonus": 0, "desc": "Medium armor. AC = 14 + DEX (max +2). Equip/unequip/swap takes 10 turns.", "armor_cat": 2, "base_ac": 14, "dex_cap": 2, "gold": 400},
	{"name": "Half Plate Armor",       "type": 1, "src": "items", "icon": "Materials/PlateGold.png", "bonus_dmg": 0, "heal": 0, "str_bonus": 0, "desc": "Medium armor. AC = 15 + DEX (max +2). Disadvantage on Stealth. Equip/unequip/swap takes 10 turns.", "armor_cat": 2, "base_ac": 15, "dex_cap": 2, "stealth_disadv": true, "gold": 750},
	{"name": "Ring Mail",              "type": 1, "src": "items", "icon": "Materials/PlateIron.png", "bonus_dmg": 0, "heal": 0, "str_bonus": 0, "desc": "Heavy armor. AC = 14 (no DEX bonus). Disadvantage on Stealth. Equip/unequip/swap takes 15 turns.", "armor_cat": 3, "base_ac": 14, "dex_cap": 0, "stealth_disadv": true, "gold": 30},
	{"name": "Chain Mail",             "type": 1, "src": "items", "icon": "Materials/PlateIron.png", "bonus_dmg": 0, "heal": 0, "str_bonus": 0, "desc": "Heavy armor. AC = 16 (no DEX bonus). Requires 13 STR. Disadvantage on Stealth. Equip/unequip/swap takes 15 turns.", "armor_cat": 3, "base_ac": 16, "dex_cap": 0, "str_req": 13, "stealth_disadv": true, "gold": 75},
	{"name": "Splint Armor",           "type": 1, "src": "items", "icon": "Materials/PlateGold.png", "bonus_dmg": 0, "heal": 0, "str_bonus": 0, "desc": "Heavy armor. AC = 17 (no DEX bonus). Requires 15 STR. Disadvantage on Stealth. Equip/unequip/swap takes 15 turns.", "armor_cat": 3, "base_ac": 17, "dex_cap": 0, "str_req": 15, "stealth_disadv": true, "gold": 200},
	{"name": "Plate Armor",            "type": 1, "src": "items", "icon": "Materials/PlateGold.png", "bonus_dmg": 0, "heal": 0, "str_bonus": 0, "desc": "Heavy armor. AC = 18 (no DEX bonus). Requires 15 STR. Disadvantage on Stealth. Equip/unequip/swap takes 15 turns.", "armor_cat": 3, "base_ac": 18, "dex_cap": 0, "str_req": 15, "stealth_disadv": true, "gold": 1500},

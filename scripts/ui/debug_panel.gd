...
const ALL_ITEMS: Array = [
	...
	{"name": "Torch",           "type": 0, "src": "weapons", "icon": "weapon_torch.png",                      "bonus_dmg": 0, "heal": 0,   "str_bonus": 0, "desc": "", "die_min": 1, "die_max": 4, "dmg_type": "Bludgeoning", "category": "Simple", "torch": true},

...
- **Procedural dungeon generation** - BSP tree, 48x48 grid, L-shaped corridors, reproducible per run seed + floor, guaranteed multi-path connectivity between entrance/exit rooms
- **Turn-based combat** - bump-to-attack, diagonal movement, ADV/DISADV house rules, Opportunity Attacks, Stealth & Surprise Attacks, weapon masteries (Cleave, Vex, Push, Graze, Topple, Sap, Nick, Slow)
- **D&D 5.5e (2024) mechanics** - point-buy ability scores, background ASI, modifiers, proficiency bonus, armor class, 7 real D&D Conditions (Poisoned, Prone, Restrained, Incapacitated, Blinded, Frightened, Paralyzed), Exhaustion, and a dramatic BG3-style death-save sequence instead of instant death at 0 HP
...
- **Special rooms & economy** - Shop, Treasure, Garden, and Secret rooms, a gold-currency wallet, and a Blacksmith weapon-forging sink
...
| **I** | Open inventory |
| **O** | Open Wizard Spellbook |
| **R** | Open Rest panel (short/long rest) |
| **Tab** | Toggle item bar / ability bar |
| 1-9 | Use quickbar/ability-bar slot |
| Left-click enemy | Chase + melee attack |
| Shift + left-click | Ranged attack |
| Alt + left-click | Cast the Special quick-cast spell |
| Ctrl + left-click | Instant Inspect |
...
All sprites from [0x72 DungeonTilesetII](https://0x72.itch.io/dungeontileset-ii) (CC0, 16x16 px), plus Superdark's CC0 16x16 packs for newer character sets.
